...
for i in range(1):
    ...
    r1,a1,q1=q_learning(env1,1,alpha,epsilon,1000)
    r2,a2,q2=q_learning(env2,1,alpha,epsilon,1000)
    r3,a3,q3=q_learning(env3,1,alpha,epsilon,1000)
    r4,a4,q4=q_learning(env4,1,alpha,epsilon,1000)
...
# plt.savefig('Qlearning reward1.pdf')
# plt.close()
...
# plt.savefig('Harvest Rewards1.pdf')
# plt.close()
...
# plt.ylabel("Number of harvests")
# plt.title("No of harvests vs Patches")
# plt.savefig('Harvest Rewards2.pdf')
# plt.close()