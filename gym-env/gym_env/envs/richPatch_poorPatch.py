...
class ForagingRichPoorPatch(gym.Env):
    ...
    def step(self, action: int):
        ...
        if action == 1:
            if self.elapsed_time + self.decision_time > self.total_time:
                ...
                reward = self.initial_reward - 0.5*self.state
            ...
            if self.elapsed_time + self.interval_time > self.total_time:
                ...
                self.state = 0
                # self.initial_reward = self.np_random.choice([self.np_random.randint(2,7), self.np_random.randint(10,15)])
    ...
    def set_init_reward(self,r):
        self.initial_reward = r
