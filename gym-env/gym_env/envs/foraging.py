...
class Foraging(gym.Env):
    ...
    def __init__(self, interval_time=10, total_time=4,decision_time = "" ) -> None:
    ...
    def step(self, action: int):
        ...
        # decision_time = 1
        if self.decision_time == "N":
            decision_time = 1
        elif self.decision_time == "L":
            decision_time = 0.6
        elif self.decision_time == "H":
            decision_time = 1.4
        else:
            decision_time = self.np_random.uniform(0.6,1.4)
        done=False
        reward = 0
        # print(decision_time)
        if action == 1:
